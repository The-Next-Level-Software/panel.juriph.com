...
export default function MessagesPage() {
  ...
  return (
    // ✅ lock viewport height + no page scroll
    <div className="h-[100dvh] bg-white overflow-hidden sm:px-10">
      <div className="h-full grid grid-cols-1 lg:grid-cols-[420px_1fr] overflow-hidden">
        ...
        <aside
          className={[
            ...
            "flex flex-col min-h-0", // ✅ important
            mobileView === "list" ? "flex" : "hidden lg:flex",
          ].join(" ")}
        >
          <div className="px-8 pt-8 pb-5 mt-20 shrink-0">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <span className="inline-flex mt-2 px-3 py-1 rounded-full text-[11px]
        ...
        >
          ...
          <div className="shrink-0 border-b mt-20 border-neutral-100 bg-white">
            <div className="px-6 lg:px-10 h-[80px] flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <Avatar src={activeChat.avatar} alt={activeChat.name} size={46} />
          ...
          <div className="flex-1 min-h-0 flex flex-col bg-white overflow-hidden">
                ...
                {messages.map((m) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {!isMe && (
                          <Avatar src={activeChat.avatar} alt="avatar" size={30} />
                        )}
            ...
            <div className="shrink-0 border-t border-black/5 pr-10 pl-5 bg-white">
              <div className="px-4 sm:px-6 lg:px-10 py-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex  w-full  py-1 px-1 rounded-xl bg-white border border-black/10 focus:border-[#9A6A1B] focus:ring-2 focus:ring-[#9A6A1B]/20">
                  <input
                    value={draft}
