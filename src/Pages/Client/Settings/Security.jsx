  ...
  return (
    <div className="min-h-[100dvh] bg-white  ">
      <div className=" w-full max-w-[920px]  px-5 sm:px-7 py-1">
        <h1 className="text-[30px] font-semibold text-[#454545]">Privacy & Security</h1>

        
          <Row
            label="Make my profile visible to lawyers."
            value={prefs.emailBids}
            onChange={(v) => setPrefs((p) => ({ ...p, emailBids: v }))}
          />
          <Row
            label="Allow lawyers to contact me directly."
