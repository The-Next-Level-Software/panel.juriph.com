...
export default function ActiveCases() {
  ...
  return (
    <div className="min-h-screen mt-4 bg-white">
      <div className="mx-auto w-full  px-1 sm:px-4 py-4">
        {/* Header */}
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
          {/* Title */}
          <h1 className="px-5 text-[25px] font-medium text-[#1E1E1E] sm:px-5 sm:text-[26px]">
            Active Cases
          </h1>

          {/* Actions */}
          <div className="flex flex-wrap items-center justify-end gap-3 px-5 sm:px-0 sm:mr-3 sm:gap-6">
            <button
              type="button"
      ...
      <div className="rounded-xl bg-[#F4F4F4] p-5 sm:p-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            <h2 className="text-[18px] sm:text-[20px] font-[700] text-[#414749]">
              {data.title}
            </h2>
        ...
        {/* Assigned lawyer */}
        <div className="mt-7">
          <p className="text-[11px] text-[#8B8B8B] mb-2">Assigned Lawyer</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <p className="text-[14px] font-medium text-[#414749]">
                {data.lawyerName}
              </p>
        ...
        <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div className="rounded-lg bg-[#E3A853] px-4 py-3 text-white">
            <p className="text-[12px] font-[600] opacity-95">Proposed Fee</p>

            <div className="mt-2 flex items-center justify-between gap-3">
              <span className="text-[20px] ">${data.fee}</span>

              {data.escrow && (
                <span className="rounded-md bg-[#F1C27A] px-3 py-1 text-[12px] font-[700] text-[#414749]">
                  In Escrow
                </span>
              )}
            </div>
          ...
          {/* Deadline */}
          <div className="rounded-lg bg-[#E9ECEC] px-4 py-3">
            <p className="text-[12px] font-[600] text-[#6B6B6B]">Deadline</p>
            <p className="mt-2 text-[17px] font-[600] text-[#414749]">
              {data.deadline}
            </p>
          </div>
        ...
        <div className="mt-5 grid grid-cols-1 sm:grid-cols-3 gap-3">
          <button
            ...
            type="button"
            className="h-[44px] cursor-pointer rounded-md bg-[#E3A853] text-white font-[600]
          ...
          <button
            type="button"
            className="h-[44px] cursor-pointer rounded-md bg-white font-[600] text-[#414749]
          ...
          <button
            type="button"
            className="h-[44px] rounded-md cursor-pointer bg-[#9FA8A8] text-white font-[600]
                       hover:brightness-[0.98] active:scale-[0.99] transition"
          >
            Close Case
          </button>
