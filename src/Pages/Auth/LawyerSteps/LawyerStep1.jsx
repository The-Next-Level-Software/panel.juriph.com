...
export default function LawyerStep1() {
  ...
  const handleNext = () => {
    ...
    localStorage.setItem("juriph_Lawyer_step_1", JSON.stringify(form));

    // ✅ go next step (change route as per your app)
    navigate("/lawyer-welcome/lawyer-step-2");
  };
            ...
            <div className="mt-10 sm:mt-14">
              ...
              `}
                ...
                <div className="flex justify-end">
                  <span className="text-sm text-[#111827]">Step 1/5</span>
                </div>
              </div>
            </div>
          </div>
