...
export default function LawyerWelcome() {
  ...
  const isWelcomeOnly = location.pathname === "/lawyer-welcome";
          ...
          <div className="w-full max-w-md sm:max-w-lg">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-[#393E40] mt-5 text-md sm:text-base leading-relaxed max-w-xl">
                Our platform connects you with clients seeking your expertise.
                Let’s complete your profile so we can match you with the right
                cases.
              </p>
            </div>
            ...
            <div className="mt-8 space-y-7">
              <button
                onClick={() => navigate("/lawyer-welcome/lawyer-step-1")}
                disabled={!active}
